...
class OfTheWeekFooter extends Component {
  ...
  renderOfTheDayData(otdData) {
    ...
    return (
      <TouchableOpacity 
        ...
        key={day}
        onPress={() => { this.state.setWeekType(otdData.dotw); this.setHighlighted(day); }}
      >
  ...
  render() {
    ...
    return (
      <LinearGradient colors={getGradientColor('OfTheWeekFooter')} style={OfTheDayFooterStyle.container}>
...
export default OfTheWeekFooter;
